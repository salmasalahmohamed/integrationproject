...
<nav class="site-nav">
    <div class="container">
        <div class="site-navigation">
            <a  class="logo m-0">Homespace <span class="text-primary">.</span></a>
...
<div class="untree_co_slider-wrap" data-aos="fade-up">
    ...
    <div class="untree_co_slider">
        <div class="item">
            <img src="{{asset('images/property_1-min.jpg')}}" alt="Image" class="img-fluid">
        ...
        <div class="item">
            <img src="public/images/property_2-min.jpg" alt="Image" class="img-fluid">
        ...
        <div class="item">
            <img src="public/images/property_3-min.jpg" alt="Image" class="img-fluid">
        ...
        <div class="item">
            <img src="public/images/property_1-min.jpg" alt="Image" class="img-fluid">
...
<div class="untree_co-section bg-light">
    ...
    <div class="owl-3-slider owl-carousel">
        ...
        <div class="item">
            <div class="property-entry">
                <img src="{{asset('images/property_2-min.jpg')}}" alt="Image" class="img-fluid">
                <div class="property-specs">
    ...
    <div class="container">
        <div class="row align-items-center justify-content-between">
            ...
            <div class="col-lg-6 mb-4 mb-lg-0">
                <img src="public/images/img_portrait_1.jpg" alt="Image" class="img-fluid rounded">
            </div> <!-- /.col-lg-4 -->
        ...
        <div class="row align-items-stretch">
            <div class="col-lg-4 mb-4 mb-lg-0">
                <div class="untree_co-testimonial h-100">
                    ...
                    <div class="author d-flex align-items-center">
                        <div class="author-picture mr-3"><img src="public/images/person_1.jpg" alt="Image" class="img-fluid"></div>
            ...
            <div class="col-lg-4 mb-4 mb-lg-0">
                <div class="untree_co-testimonial h-100">
                    ...
                    <div class="author d-flex align-items-center">
                        <div class="author-picture mr-3"><img src="public/images/person_2.jpg" alt="Image" class="img-fluid"></div>
                        <div class="author-name">
                            <strong class="d-block">John Smith</strong>
                            <span>CTO &mdash; Slack, Inc.</span>
                        </div>
            ...
            <div class="col-lg-4 mb-4 mb-lg-0">
                <div class="untree_co-testimonial h-100">
                    ...
                    <div class="author d-flex align-items-center">
                        <div class="author-picture mr-3"><img src="public/images/person_3.jpg" alt="Image" class="img-fluid"></div>
                        <div class="author-name">
                            <strong class="d-block">John Smith</strong>
                            <span>CTO &mdash; Slack, Inc.</span>
                        </div>
